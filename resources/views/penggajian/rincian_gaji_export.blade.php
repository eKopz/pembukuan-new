<table>
    <thead>
        ...
        <tr>
            ...
            <th style="text-align: center" colspan="3"><b>Tunjangan</b></th>
            ...
            <th style="text-align: center" colspan="7"><b>Potongan</b></th>
            <th style="text-align: center" rowspan="3"><b>Jumlah Diterima</b></th>
        </tr>
        <tr>
            <th style="text-align: center" rowspan="2"><b>Makan</b></th>
            <th style="text-align: center" rowspan="2"><b>Transport</b></th>
            <th style="text-align: center" rowspan="2"><b>Insentif</b></th>
            ...
            <th style="text-align: center" rowspan="2"><b>Pinj. Koperasi</b></th>
            <th style="text-align: center" rowspan="2"><b>Mangkir</b></th>
    ...
    <tbody>
        @foreach ($gaji as $item => $value)
            ...
            <tr>
                ...
                <td>Rp. {{ number_format($value->lembur,0,',','.') }}</td>
                ...
                <td>Rp. {{ number_format($value->jamsostek,0,',','.') }}</td>
                <td>Rp. {{ number_format(($value->karyawan_koperasi->gaji_pokok + $value->makan + $value->transport + $value->insentif + $value->lembur + $value->rapel + $value->jamsostek) - ($value->potongan_simpanan_wajib + $value->potongan_simpanan_pokok + $value->potongan_simpanan + $value->potongan_pinjaman + $pph + $value->jamsostek),0,',','.') }}</td>
            </tr>            
        @endforeach
        <tr>
            ...
            <td><b>Rp. {{ number_format($gaji->sum('lembur'),0,',','.') }}</b></td>
            <td><b>Rp. {{ number_format($gaji->sum('jamsostek'),0,',','.') }}</b> </td>
            <td><b>Rp. {{ number_format($gaji->sum('gaji_pokok') + $gaji->sum('makan') + $gaji->sum('transport') + $gaji->sum('insentif') + $gaji->sum('lembur') + $gaji->sum('rapel') + $gaji->sum('jamsostek'),0,',','.') }}</b></td>
