...
@section('content-title')
    <div class="col p-0">
        <h4 class="text-success">Edit Kas</h4>
    ...
    <div class="col p-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active text-success">Form Edit Kas</li>
        </ol>
    </div>
@endsection
...
<div class="col-xl-12">
    <div class="card forms-card">
        <div class="card-body">
            <h4 class="card-title mb-4">Form Edit Kas</h4>
            <div class="basic-form">
                <form action="/kas/update/{{ $kas->id }}" method="post" multiple="multiple" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label class="text-label">Uraian</label>
                        <input type="text" name="uraian" class="form-control" value="{{ $kas->uraian }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kas" class="js-example-placeholder-multiple form-control">
                            <option @if ($kas->jenis_kas == 1) selected @endif value="1">Kas Masuk</option>
                            <option @if ($kas->jenis_kas == 2) selected @endif value="2">Kas Keluar</option>
                        </select>
                    </div>
