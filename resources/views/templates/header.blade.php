        ...
        <ul>
            ...
            <li class="icons">
                <a href="javascript:void(0)" class="log-user">
                    ...
                    <img @if (Session::get('foto') == null) src="{{ asset('assets/images/profile/1.jpg') }}" @else src="{{ Session::get('foto') }}" @endif alt=""> <span>{{ Session::get('nama_koperasi') }}</span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                </a>
                <div class="drop-down dropdown-profile animated bounceInDown">
                    <div class="dropdown-content-body">
                        <ul>
                            <li><a href="/profile"><i class="fa fa-user"></i> <span>Profile</span></a>
                            </li>
